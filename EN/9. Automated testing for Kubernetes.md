...
He contrastado this module with documentación oficial and fuentes primarias actuales: `kubectl apply`, `kubectl diff`, Kustomize, kind, kubeconform, kube-score, Polaris, Kyvernot CLI, Conftest, Chainsaw, KUTTL, Terratest and Sonobuoy. Also he separado what parte sirve for validate manifests, what parte sirve for probar políticas, what parte needs a cluster real and what parte pertenece more to platform teams que to each PR of an application.
