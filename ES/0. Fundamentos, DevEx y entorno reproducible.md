...
![Mapa general de la sección 0](images/0-fundamentos/01-fundamentos-devex-entorno.svg)
...
![Checklist de diagnóstico por capas para checkout-api](images/0-fundamentos/05-capas-de-fallo-checkout-api.svg)
...
![Comparación entre SIGTERM y SIGKILL](images/0-fundamentos/02-senales-graceful-shutdown.svg)
...
![Flujo kubectl, JSON/YAML y consultas estructuradas](images/0-fundamentos/04-json-yaml-jq-yq-kubectl.svg)
...
![Estructura reproducible del laboratorio](images/0-fundamentos/03-lab-estructura-reproducible.svg)
