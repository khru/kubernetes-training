<!-- COURSE_NAV_START -->
[Anterior](<0. Fundamentos, DevEx y entorno reproducible.md>) | [Indice](README.md) | [Siguiente](<2. Por qué aparece Kubernetes.md>)
<!-- COURSE_NAV_END -->
...
![Modelo base de imagen y contenedor](images/1-contenedores/01-modelo-imagen-contenedor.svg)
...
![Ecosistema Docker, Podman, OCI y CRI](images/1-contenedores/02-ecosistema-docker-podman-oci-cri.svg)
...
![Ciclo de vida de una imagen de contenedor](images/1-contenedores/03-ciclo-vida-imagen.svg)
...
![Contrato HTTP mínimo de checkout-api](images/1-contenedores/04-contrato-http-checkout-api.svg)
...
![Compose como puente y diferencia frente a Kubernetes](images/1-contenedores/05-compose-vs-kubernetes.svg)
